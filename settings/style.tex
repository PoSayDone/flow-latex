...
\titleformat*{\subsubsection}{\fontsize{14}{14}\bfseries\centering}
...
\DeclareCaptionFormat{myformat}{\fontsize{12}{14}\selectfont#1#2#3}
\captionsetup{skip=0pt}
\captionsetup[figure]{format=myformat, name=Рисунок, labelsep=endash, aboveskip=2pt}
...
% \setlist[2]{noitemsep, topsep=-3pt, leftmargin=0.4cm}
